module.exports = class Scene {
  ...
  init(){
    ...
    this._story = require(this.core.config.path.board + sname);
  ...
  async open(){
    ...
    var page = taken.story.page;
    page.on('domcontentloaded', async () => {
      try{
        await taken.story.page.evaluate((j) => {
        ...
        console.log("$P injection aborted.");
      }
    });
  ...
  async read(){
    ...
    */
    try{
      ...
      this.core.log_error(e.message);
      this.core.log_error(e.stack);
    }
  }
