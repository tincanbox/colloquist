...
module.exports = class Scene {
  ...
  async commence(){
    ...
    if(this.space_session){
      // Re-apply cookies.
      for(let ck of this.scenario.session(this.space_session)){
   ...
   */
  async read(){
    this.core.logger.debug("I'm gonna tell you a Story about... " + this.protocol.href);
    this.info.started_at = new Date();
    this.core.logger.debug("started_at: " + this.info.started_at.toString());
