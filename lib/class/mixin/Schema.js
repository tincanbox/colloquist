module.exports = class Schema {
  ...
  constructor(name, conn, option){
    ...
    switch(this.db.module){
      case "mongoose":
        this.__structure_translation = {
          "string":     [ String,      (v) => FM.vr.is_s(v) ? v : FM.vr.to_s(v) ],
          "text":       [ String,      (v) => FM.vr.is_s(v) ? v : FM.vr.to_s(v) ],
          "object":     [ Object,      (v) => v ],
          "array":      [ Array,       (v) => FM.vr.to_a(v) ],
          "integer":    [ Number,      (v) => v ],
          "datetime":   [ Date,        (v) => v ],
        };
        break;
      case "sequelize":
        ...
        this.__structure_translation = {
          "string":     [ tps.STRING,  (v) => FM.vr.is_s(v) ? v : FM.vr.to_s(v) ],
          "text":       [ tps.TEXT,    (v) => FM.vr.is_s(v) ? v : FM.vr.to_s(v) ],
          "object":     [ tps.TEXT,    (v) => FM.vr.stringify(v) ],
          "array":      [ tps.TEXT,    (v) => FM.vr.stringify(v) ],
